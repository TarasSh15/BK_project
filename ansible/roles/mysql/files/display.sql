...
--
-- Table structure for table `disp_tech`
--

DROP TABLE IF EXISTS `disp_tech`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `disp_tech` (
  `tech_id` tinyint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `disp_tech`
--

LOCK TABLES `disp_tech` WRITE;
/*!40000 ALTER TABLE `disp_tech` DISABLE KEYS */;
INSERT INTO `disp_tech` VALUES (1,'LCD TFT'),(2,'LCD UV2A'),(3,'LED BLU'),(4,'IPS'),(5,'SMD'),(6,'D-LED'),(7,'E-LED BLU'),(8,'OLED');
/*!40000 ALTER TABLE `disp_tech` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2021-12-15 14:57:08
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: display
-- ------------------------------------------------------
...
--
-- Table structure for table `resol_list`
--

DROP TABLE IF EXISTS `resol_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `resol_list` (
  `resol_id` tinyint NOT NULL AUTO_INCREMENT,
  `resol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`resol_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `resol_list`
--

LOCK TABLES `resol_list` WRITE;
/*!40000 ALTER TABLE `resol_list` DISABLE KEYS */;
INSERT INTO `resol_list` VALUES (19,'1920x1080'),(20,'2048 × 1080'),(38,'3840x2160'),(76,'7680x4320');
/*!40000 ALTER TABLE `resol_list` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
